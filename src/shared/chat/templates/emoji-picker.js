...
const emoji_item = o => {
    return html`
        <li
            class="emoji insert-emoji ${o.shouldBeHidden(o.emoji.sn) ? 'hidden' : ''}"
            data-emoji="${o.emoji.sn}"
            title="${o.emoji.sn}"
        >
...
const emojis_for_category = o => {
    return html`
        <a id="emoji-picker-${o.category}" class="emoji-category__heading" data-category="${o.category}"
...
const skintone_emoji = o => {
    return html`
        <li data-skintone="${o.skintone}" class="emoji-skintone ${o.current_skintone === o.skintone ? 'picked' : ''}">
            <a class="pick-skintone" href="#" data-skintone="${o.skintone}" @click=${o.onSkintonePicked}
                >${u.shortnamesToEmojis(':' + o.skintone + ':')}</a
            >
        </li>
    `;
};
