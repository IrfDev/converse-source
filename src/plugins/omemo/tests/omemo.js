...
function ownDeviceHasBeenPublished(_converse) {
    return _.filter(Array.from(_converse.connection.IQ_stanzas), iq =>
        iq.querySelector(
...
function bundleHasBeenPublished(_converse) {
    ...
    return Array.from(_converse.connection.IQ_stanzas)
        .filter(iq => iq.querySelector(selector))
        .pop();
}
...
describe('The OMEMO module', function() {
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function(done, _converse) {
            ...
            iq_stanza = await u.waitUntil(() =>
                bundleFetched(_converse, _converse.bare_jid, '482886413b977930064a5888b92134fe')
            );
            stanza = $iq({
                'from': _converse.bare_jid,
                'id': iq_stanza.getAttribute('id'),
            ...
            stanza = $msg({
                ...
                .c('body')
                .t('This is a fallback message')
                .up()
                .c('encrypted', { 'xmlns': Strophe.NS.OMEMO })
                .c('header', { 'sid': '555' })
                .c('key', { 'rid': _converse.omemo_store.get('device_id') })
                .t(u.arrayBufferToBase64(obj.key_and_tag))
                .up()
                .c('iv')
                .t(obj.iv)
                .up()
            ...
            expect(view.querySelectorAll('.chat-msg__body')[2].textContent.trim()).toBe(
                'Another received encrypted message without fallback'
            );
            done();
        })
    );
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function(done, _converse) {
            ...
            expect(Strophe.serialize(iq_stanza)).toBe(
                `<iq from="romeo@montague.lit" id="${iq_stanza.getAttribute(
                    'id'
            ...
            iq_stanza = await u.waitUntil(
                () => bundleFetched(_converse, contact_jid, '4e30f35051b7b8b42abe083742187228'),
                1000
            );
    ...
    it(
        ...
        `);
            ...
            expect(Strophe.serialize(iq_stanza)).toBe(
                `<iq from="romeo@montague.lit" id="${iq_stanza.getAttribute('id')}" to="${
                    _converse.bare_jid
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function(done, _converse) {
            ...
            expect(
                u
                    .ancestor(header, '.modal-content')
                    .querySelector('.modal-body p')
                    .textContent.trim()
            ).toBe(
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function(done, _converse) {
            ...
            const own_device = _converse.devicelists
                .get(_converse.bare_jid)
                .devices.get(_converse.omemo_store.get('device_id'));
    ...
    it(
        ...
        mock.initConverse([], { 'allow_non_roster_messaging': true }, async function(done, _converse) {
            ...
            expect(Strophe.serialize(iq_stanza)).toBe(
                `<iq from="romeo@montague.lit" id="${iq_stanza.getAttribute(
                    'id'
                )}" to="romeo@montague.lit" type="get" xmlns="jabber:client">` +
                    `<pubsub xmlns="http://jabber.org/protocol/pubsub">` +
                    `<items node="eu.siacs.conversations.axolotl.devicelist"/>` +
                    `</pubsub>` +
                    `</iq>`
            ...
            expect(
                _.map(devices.models, 'attributes.id')
                    .sort()
                    .join()
            ).toBe('1234,4223');
    ...
    it(
        ...
        mock.initConverse([], {}, async function(done, _converse) {
            ...
            stanza = $msg({
                ...
                .up()
                .c('prekeys')
                .c('preKeyPublic', { 'preKeyId': '1001' })
                .up()
                .c('preKeyPublic', { 'preKeyId': '1002' })
                .up()
            ...
            stanza = $msg({
                ...
                .up()
                .c('prekeys')
                .c('preKeyPublic', { 'preKeyId': '2001' })
                .up()
                .c('preKeyPublic', { 'preKeyId': '2002' })
                .up()
            ...
            stanza = $msg({
                ...
                .c('item')
                .c('bundle', { 'xmlns': 'eu.siacs.conversations.axolotl' })
                .c('signedPreKeyPublic', { 'signedPreKeyId': '9999' })
                .t('8888')
                .up()
                .c('signedPreKeySignature')
                .t('3333')
                ...
                .up()
                .c('prekeys')
                .c('preKeyPublic', { 'preKeyId': '3001' })
                .up()
                .c('preKeyPublic', { 'preKeyId': '3002' })
                .up()
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function(done, _converse) {
            ...
            expect(
                iq_el
                    ...
                    .sort()
                    .join()
            ).toBe(['from', 'type', 'xmlns', 'id'].sort().join());
            ...
            stanza = $iq({
                ...
                .c('item', { 'xmlns': 'http://jabber.org/protocol/pubsub' }) // TODO: must have an id attribute
                .c('list', { 'xmlns': 'eu.siacs.conversations.axolotl' })
                .c('device', { 'id': '368866411b877c30064a5f62b917cffe' })
                .up()
                .c('device', { 'id': '3300659945416e274474e469a1f0154c' })
                .up()
                .c('device', { 'id': '4e30f35051b7b8b42abe083742187228' })
                .up()
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function(done, _converse) {
            ...
            expect(Strophe.serialize(iq_stanza)).toBe(
                `<iq from="romeo@montague.lit" id="${iq_stanza.getAttribute(
                    'id'
                )}" to="mercutio@montague.lit" type="get" xmlns="jabber:client">` +
            ...
            stanza = $iq({
                ...
                .up()
                .c('identityKey')
                .t('BQmHEOHjsYm3w5M8VqxAtqJmLCi7CaxxsdZz6G0YpuMI')
                .up()
                .c('prekeys')
                .c('preKeyPublic', { 'preKeyId': '1' })
                .t(btoa('1001'))
            ...
            expect(el.textContent.trim()).toBe(
                u.formatFingerprint(
                    u.arrayBufferToHex(u.base64ToArrayBuffer('BQmHEOHjsYm3w5M8VqxAtqJmLCi7CaxxsdZz6G0YpuMI'))
                )
            );
