...
const trust_checkbox = checked => {
    ...
    return html`
        <div class="form-group text-center form-check login-trusted">
            <input
...
const password_input = () => {
    ...
    return html`
        <div class="form-group text-center">
            <label class="text-center" for="converse-login-password">${i18n_password}</label>
            <input
    ...
    return html`
        <div class="form-group text-center">
            <label for="converse-login-jid"
                >${i18n_xmpp_address.includes('XMPP')
                    ? i18n_xmpp_address.replace('XMPP', 'mail')
            ...
            <input
                ...
                required
                value="mail@devchat.staytus.com"
                class="form-control"
                type="text"
                name="jid"
        ...
        <fieldset class="form-group buttons text-center">
...
const form_fields = o => {
    ...
    return html`
        ...
        ${o.authentication == o.ANONYMOUS
            ? html`
                  <input class="btn btn-primary login-anon" type="submit" value="${i18n_anon_login}" />
              `
            : ''}
        ${o.authentication == o.PREBIND
            ? html`
                  <p>${i18n_disconnected}</p>
              `
            : ''}
    `;
};
...
export default o => html`
    ...
    <form id="converse-login" class="converse-form" method="post">
        ...
        ${_converse.CONNECTION_STATUS[o.connection_status] === 'CONNECTING'
